...
![ERP-Lite](https://img.shields.io/badge/ERP--Lite-9%20Integrated%20Modules-purple)
![AI Copilot](https://img.shields.io/badge/AI%20Copilot-Claude%203.5%20%2F%20Deterministic-indigo)
![Tests](https://img.shields.io/badge/Tests-80%20Passing-brightgreen?logo=pytest&logoColor=white)
![License](https://img.shields.io/badge/License-MIT-orange)

> **“When the factory changes, the schedule changes with it.”**

**FlowForge AI** is an industrial-grade autonomous production resilience, shop-floor scheduling, and ERP-lite operations platform. Designed with an Apple-grade editorial interface and high-performance algorithmic backend, FlowForge continuously monitors factory conditions, detects machine failures, rush orders, and bottleneck shifts in real time, computes multi-objective optimized recovery plans, and provides complete shop-floor visibility across 9 integrated operational modules.
